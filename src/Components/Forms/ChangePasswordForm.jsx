    ...
    return (
        <>
            ...
            <form action="" onSubmit={performValidation}>
                <InputAuth name='newPassword' value={oldPassValue} onChange={(e) => { setOldPassValue(e.target.value) }} type='password' placeholder="Новый пароль" />
                <InputAuth name='newPassword2' value={newPassValue} onChange={(e) => { setNewPassValue(e.target.value) }} type='password' placeholder="Повторите новый пароль" />
